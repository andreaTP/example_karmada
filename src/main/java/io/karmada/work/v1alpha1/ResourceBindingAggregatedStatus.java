...
public class ResourceBindingAggregatedStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private ResourceBindingStatus status;

    public ResourceBindingStatus getStatus() {
        return status;
    }

    public void setStatus(ResourceBindingStatus status) {
        this.status = status;
    }
}
