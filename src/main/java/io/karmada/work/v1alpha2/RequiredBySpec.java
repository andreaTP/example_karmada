...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"clusters","name","namespace"})
...
public class RequiredBySpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
