...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"apiVersion","kind","labelSelector","name","namespace"})
...
public class ResourceSelectorsSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
