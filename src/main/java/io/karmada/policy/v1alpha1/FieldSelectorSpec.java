...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"matchExpressions"})
...
public class FieldSelectorSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
